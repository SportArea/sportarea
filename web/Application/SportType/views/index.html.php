    ...
    <div class="col-md-12">
        <div class="portlet light bordered bg-inverse">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <button class="btn btn-sm margin-bottom green-meadow" data-href="<?php echo BASE_URL ?>/sport_type/add" style="border: solid #1CAF9A 1px">
                ...
                <div class="tabbable tabbable-custom">
                    <div class="tab-content">
                        <div class="tab-pane fade active in custom-table-list">
                            ...
                            <div class="portlet-body">
                                <table id="sport_type" class="table table-striped table-bordered table-hover dataTable table-turquoise">
                                    <thead>
                                    <tr>
                                        <th></th>
                                        <th>Denumire</th>
